        ...
        local _natives = {
            ...
            ["GetOffsetFromEntityInWorldCoords"] = {
                ...
                unpack = function(...)
                    ...
                    -- Default offset values to 0.0 if not provided
                    return args[1], args[2] or 0.0, args[3] or 0.0, args[4] or 0.0, dict.Citizen.ReturnResultAnyway(), dict.Citizen.ResultAsVector()
